...
namespace ArchotechPlus
{
    public class ArchotechPlus : Mod
    {
        ...
        public override void DoSettingsWindowContents(Rect inRect)
        {
            ...
            listingStandard.CheckboxLabeled("Regenerator heals removed Eyes", ref ArchotechPlusSettings.RegeneratorAlwaysHealEyes, "Default: Disabled");
            listingStandard.Label("even when Ideology wants Blindness");
            ...
            listingStandard.NewColumn();
            listingStandard.Gap(Text.LineHeight * 7f);
            ...
            if (ArchotechPlusSettings.RegeneratorResurrects)
            {
                listingStandard.Gap(Text.LineHeight * 4f);
                listingStandard.Label(
